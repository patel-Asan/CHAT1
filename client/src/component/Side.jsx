...
import { FaPlus, FaUserFriends, FaUsers, FaTimes } from "react-icons/fa";

const UserItem = ({ user, isSelected, isOnline, unseenCount, onClick, compact }) => {
  ...
  return (
    ...
    >
      <div
        style={{
          background: "#1e293b",
          borderRadius: fullScreen ? "20px 20px 0 0" : "16px",
          padding: fullScreen ? "20px" : "24px",
          width: "100%",
          maxWidth: fullScreen ? "100%" : "400px",
          maxHeight: fullScreen ? "85vh" : "80vh",
          overflowY: "auto",
...
const Side = () => {
  ...
  return (
    <div
      style={{
        backgroundColor: "rgba(129, 133, 178, 0.08)",
        height: "100%",
    ...
    >
      ...
      <div style={{ paddingBottom: "10px", flexShrink: 0 }}>
        ...
        >
          <img
            src={assets.logo}
            alt="logo"
            style={{ maxWidth: isMobile ? "90px" : "120px", height: "auto" }}
          />
          <div>
            <img
              src={assets.menu_icon}
              alt="Menu"
              style={{ maxHeight: "20px", cursor: "pointer", opacity: 0.7, transition: "opacity 0.2s" }}
            ...
            {menuOpen && (
              ...
              >
                <p
                  ...
                  style={{ cursor: "pointer", fontSize: "14px", padding: "8px 12px", borderRadius: "6px", margin: 0, transition: "background 0.2s" }}
                ...
                <p
                  ...
                  style={{ cursor: "pointer", fontSize: "14px", padding: "8px 12px", borderRadius: "6px", margin: 0, color: "#F87171", transition: "background 0.2s" }}
                  onMouseOver={(e) => (e.currentTarget.style.backgroundColor = "rgba(255,255,255,0.1)")}
                  onMouseOut={(e) => (e.currentTarget.style.backgroundColor = "transparent")}
                >
                  Logout
        ...
        >
          <img src={assets.search_icon} alt="search" style={{ width: "14px", opacity: 0.5 }} />
          <input
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            type="text"
            placeholder={tab === "groups" ? "Search groups..." : "Search users..."}
            style={{ background: "transparent", border: "none", outline: "none", color: "#fff", flex: 1, fontSize: isMobile ? "16px" : "13px", height: isMobile ? "24px" : "20px" }}
          />
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: "4px", marginBottom: isMobile ? "8px" : "12px", flexShrink: 0 }}>
        <button
          onClick={() => { setTab("chats"); setSelectedGroup(null); }}
          style={{
            flex: 1,
        ...
        <button
          onClick={() => { setTab("groups"); setSelectedUser(null); }}
          style={{
            flex: 1,
            padding: "8px",
            borderRadius: "8px",
            ...
            color: tab === "groups" ? "#a78bfa" : "#9CA3AF",
            cursor: "pointer",
            fontSize: "12px",
            fontWeight: "600",
            display: "flex",
        ...
        {tab === "chats" ? (
          <>
            {filteredUsers.length === 0 ? (
              <p style={{ textAlign: "center", color: "#6B7280", fontSize: "13px", marginTop: "40px" }}>
                No users found
              </p>
            ) : (
